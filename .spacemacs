...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(symbol-overlay find-file-in-repository exec-path-from-shell add-node-modules-path)
...
you should place your code here."
  ...
  (setq exec-path (append exec-path '("~/.nvm/versions/node/v10.15.1/bin")))
...
(custom-set-faces
 ...
 '(font-lock-comment-face ((t (:background "#292e34" :foreground "gray41" :slant italic :family "Operator Mono")))))
)
